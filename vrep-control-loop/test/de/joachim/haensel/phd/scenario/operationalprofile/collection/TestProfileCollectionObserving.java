...
//               ), "luebeck-roads.net.xml", "blue"},
   ...
   public TestProfileCollectionObserving(String testID, double lookahead, double maxVelocity, double maxLongitudinalAcceleration, double maxLongitudinalDecceleration, double maxLateralAcceleration, List<Position2D> targetPoints, String mapFilenName, String color)
   {
    ...
    public void testProfileCollection() throws VRepException
    {
        ...
        writeConfiguration(configurationBuffers);
        BiConsumer<? super Long, ? super ObservationTuple> writeObservation = (timeStamp, observation) ->
        {
            if(timeStamp != null)
            {
                ...
                String fileName = String.format("./res/operationalprofiletest/normalizedtrajectories/Observation%s%06d.pyplot", _testID, timeStamp);
                try
                {
    ...
    private void writeConfiguration(final Map<Long, List<TrajectoryElement>> configurationBuffers)
    {
