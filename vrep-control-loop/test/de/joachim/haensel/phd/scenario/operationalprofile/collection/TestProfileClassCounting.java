...
//         {"luebeck_extramini_routing_challenge", 15, 120, 4.0, 4.3, 1.0, Arrays.asList(new Position2D(7882.64,4664.21), new Position2D(7797.34,4539.80)), "luebeck-roads.net.xml", "blue"},
   ...
   public TestProfileClassCounting(String testID, double lookahead, double maxVelocity, double maxLongitudinalAcceleration, double maxLongitudinalDecceleration, double maxLateralAcceleration, List<Position2D> targetPoints, String mapFilenName, String color)
   {
    ...
    @Test
    public void testProfileCollectionAndCounting() throws VRepException
    {
