...
public class TestProfileClassCounting
{
    ...
    public static Stream<Arguments> idAndSystemParameterProvider()
    {
        Collection<Object[]> result = Arrays.asList(new Object[][] 
        {
            {"luebeck_small", 15.0, 120.0, 4.0, 4.3, 0.8, Arrays.asList(new Position2D(5579.18, 3023.38), new Position2D(6375.32, 3687.02)), "luebeck-roads.net.xml", "blue" },
                ...
                // "blue"},
                // {"chandigarh_mini", 15.0, 120.0, 4.0, 4.3, 0.8,
                // Arrays.asList(new Position2D(6394.91,7882.57), new
                ...
                // Position2D(11286.49,5458.54)), "chandigarh-roads.net.xml",
                // "blue"},
                // {"luebeck_medium", 15.0, 120.0, 4.0, 4.3, 0.8,
                // Arrays.asList(new Position2D(4112.28,7084.47), new
                // Position2D(6196.74,5289.38), new
                // Position2D(10161.11,3555.67), new Position2D(3430.39,581.66),
                // new Position2D(7252.29,1130.89)), "luebeck-roads.net.xml",
                // "blue"},
                // {"luebeck_mini_routing_challenge", 15.0, 120.0, 4.0, 4.3,
                // 1.0, Arrays.asList(new Position2D(7882.64,4664.21), new
                ...
                // "blue"},
                // {"luebeck_supermini_routing_challenge", 15.0, 120.0, 4.0,
                // 4.3, 1.0, Arrays.asList(new Position2D(7894.70,4608.56), new
                // Position2D(8051.17,5536.44), new
                // Position2D(8039.89,5485.08)), "luebeck-roads.net.xml",
                // "blue"},
                // {"luebeck_extramini_routing_challenge", 15.0, 120.0, 4.0,
                // 4.3, 1.0, Arrays.asList(new Position2D(7882.64,4664.21), new
                // Position2D(7797.34,4539.80)), "luebeck-roads.net.xml",
                // "blue"},
    ...
    public void testProfileCollectionAndCounting(String testID, double lookahead, double maxVelocity, double maxLongitudinalAcceleration, double maxLongitudinalDecceleration, double maxLateralAcceleration, List<Position2D> targetPoints,
