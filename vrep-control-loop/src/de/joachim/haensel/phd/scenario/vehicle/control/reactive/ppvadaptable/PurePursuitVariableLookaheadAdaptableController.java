...
public class PurePursuitVariableLookaheadAdaptableController implements ILowerLayerControl
{
    ...
    public PurePursuitVariableLookaheadAdaptableController()
    {
    ...
    public void initController(IActuatingSensing actuatorsSensors, ITrajectoryProvider trajectoryProvider)
    {
        ...
        PurePuresuitAdaptableTargetProvider targetProvider = new PurePuresuitAdaptableTargetProvider(trajectoryBuffer, actuatorsSensors);
