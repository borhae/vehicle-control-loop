...
public class AdaptiveNavigationController implements IUpperLayerControl 
{
    ...
    private AdaptiveNavigationController(double segmentSize, double maxVelocity)
    {
    ...
    public AdaptiveNavigationController(double segmentSize, double maxVelocity, double maxLongitudinalAcceleration, double maxLongitudinalDecceleration, double maxLateralAcceleration)
    {
