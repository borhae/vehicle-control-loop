...
public class CarInterfaceActions implements ICarInterfaceActionsWithLookahead
{
    ...
    private PurePuresuitAdaptableTargetProvider _targetProvider;
    ...
    public CarInterfaceActions(IActuatingSensing actuatorsSensors, List<IArrivedListener> arrivedListeners, PurePuresuitAdaptableTargetProvider targetProvider)
    {
