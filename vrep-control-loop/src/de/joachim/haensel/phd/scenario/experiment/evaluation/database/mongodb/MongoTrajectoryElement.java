...
public class MongoTrajectoryElement implements IDatabaseTrajectory
{
    ...
    public MongoTrajectoryElement()
    {
    }
    
    public MongoTrajectoryElement(TrajectoryElement trajElem)
    {
    ...
    public MongoTrajectoryElement(Document doc)
    {
