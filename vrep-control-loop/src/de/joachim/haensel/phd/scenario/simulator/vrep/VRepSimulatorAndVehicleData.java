...
public class VRepSimulatorAndVehicleData implements ISimulatorData
{
    ...
    public VRepSimulatorAndVehicleData(VRepObjectCreation objectCreator, VRepRemoteAPI vrep, int clientID, String vehicleScriptParentName)
    {
        _vrepAPI = vrep;
        _clientID = clientID;
